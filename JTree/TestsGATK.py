...
class TestSupportGATK(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.inputs = {'test.vcf': 'www.google.com/index.html',
                      'normal.bam': 'www.google.com/index.html'}
        cls.uuid = uuid.uuid4()
        cls.local_dir = 'test_out/'
        cls.shared_dir = os.path.join(cls.local_dir, '{}/'.format(cls.uuid))
        cls.pair_dir = os.path.join(cls.shared_dir, 'pair')

        # Create Object for testing
        cls.gatk = SupportGATK(cls.inputs, cls.local_dir, cls.shared_dir, cls.pair_dir)
    ...
    def tearDownClass(cls):
        ...
        subprocess.check_call(['rm', '-r', 'test_out/{}/'.format(cls.uuid)])
